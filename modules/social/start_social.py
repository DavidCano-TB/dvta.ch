"""
Script robusto para iniciar el servidor Social
...
def main():
    print("=" * 80)
    print("DVDcoin Social - Starting Server")
    print("=" * 80)
    print()
    ...
    # Verificar puerto
    print("[2/3] Checking port 8003...")
    if not check_port(8003):
        print("⚠️  Port 8003 is already in use")
    ...
    print("  • External: https://social.dvta.ch")
    print()
