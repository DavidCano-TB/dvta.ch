#!/usr/bin/env python3
"""
Script para identificar y borrar archivos HTML de porras que ya no existen en la base de datos.
"""
...
def main():
    ...
    respuesta = input("\n¿Deseas borrar estos archivos huérfanos? (escribe 'SI' para confirmar): ")
