...
def get_ngrok_token():
    """Lee token desde config/ngrok_config.txt y escribe en conf/.ngrok_token"""
    # Leer desde config/ngrok_config.txt (ÚNICO ARCHIVO DE CONFIGURACIÓN)
