...
# Cambiar al directorio correcto (relativo al script)
...
Start-Process -FilePath "python" -ArgumentList "main.py" -WindowStyle Minimized -WorkingDirectory $projectDir
Start-Sleep -Seconds 10

Write-Host "[5/5] Iniciando túnel Cloudflare..." -ForegroundColor Yellow
Start-Process -FilePath "cloudflared.exe" -ArgumentList "tunnel --config cloudflare-dvta-config.yml run" -WindowStyle Minimized -WorkingDirectory $projectDir
